...
function ProductRegistration() {
  ...
  const registerProduct = () => {
    ...
    Axios.put(`http://localhost:3003/Inventario/${productName}`, {
      ID_Producto: productName,
      cantidad: productType,
      Ubicacion: productWeight,
      Fecha: productPrice,
    })
      .then(() => {
      ...
      <div className='form-panel'>
        <form onSubmit={handleFormSubmit}>
          <div className='form-group'>
            <label htmlFor='productName'>ID del Roedor</label>
            <input
              type='text'
              id='productName'
              value={productName}
          ...
          <br />
          <div className='form-group'>
            <label htmlFor='productType'>Nombre</label>
            <input
              type='text'
              id='productType'
              value={productType}
          ...
          <div className='form-group'>
            <label htmlFor='productWeight'>Edad</label>
            <input
              type='text'
              id='productWeight'
              value={productWeight}
          ...
          <br />
          <div className='form-group'>
            <label htmlFor='productPrice'>Sexo</label>
            <input
              type='text'
              id='productPrice'
              value={productPrice}
          ...
          <br />
          <div className='form-group'>
            <label htmlFor='productPrice'>Ingreso</label>
            <input
              type='text'
              id='productPrice'
              value={productPrice}
          ...
          <br />
          <div className='form-group'>
            <label htmlFor='productPrice'>Razo</label>
            <input
              type='text'
              id='productPrice'
              value={productPrice}
